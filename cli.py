...
For more help on specific commands, use: %(prog)s <command> --help
    ...
    gen_parser.add_argument('--format', choices=['json', 'csv', 'jsonld'], default='json', help='Output format (default: json)')
    ...
    file_parser.add_argument('--format', choices=['json', 'csv', 'jsonld'], default='json', help='Output format (default: json)')
    ...
    json_parser.add_argument('--format', choices=['json', 'csv', 'jsonld'], default='json', help='Output format (default: json)')
